        ...
        <ScrollView>
          <Center>
            <Heading
              ...
              bold
            >
              Medical Consultation Forum || Create an account.
            </Heading>
          </Center>
          <Divider my="2" />
          {message.message ? (
...
< FormControl > <FormControl.Label>Role</FormControl.Label>
<Select isInvalid={
        signUpForm.roleError
    }
    selectedValue={
        signUpForm.role
    }
    ...
    mt={2}
    // Set the margin-top value here
    onValueChange={
        value => handleChange("role", value)
    }
    // Handle value change separately
>
