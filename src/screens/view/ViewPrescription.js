...
export const ViewPrescription = ({ navigation, route }) => {
 const [userData, setUserData]=React.useState(null);
  ...
  const assets = "https://elonkiptoo.s3.us-east-2.amazonaws.com";
  React.useEffect(()=>{
                    ...
                    <>
                      {medicalRecord.prescriptions.map((item, i) => {
                        let path = hasFileExtension(item.physician_id.photo)
                          ? `${assets}/${item.physician_id.photo}`
                          ...
                          >
                            <Stack p="4" space={3}>
                              ...
                              <Center>
                                ...
                                <Link
                                  href={`http://localhost:3000/api/medical-records/${medicalRecord._id}/prescriptions/${item._id}/export`}
                                  isExternal
                                  _text={{
                                    color: "blue.400"
                                  }}
